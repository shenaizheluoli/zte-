...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_path', type=str, default="../data/noise/")
    parser.add_argument('--output_path', type=str, default="../data/result/")
    parser.add_argument('--ground_path', type=str, default="../data/gt/")
    ...
    for img_name in imgnames:
        ...
        # denoise_raw(input_path, output_path, args.model_path, args.ground_path, args.black_level, args.white_level)